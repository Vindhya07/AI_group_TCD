...
def plot1():
    ...
    ax2.plot(mcts_rows[2], color="blue", label="Deep First Search")
    ...
    ax2.set_title("DFS: Time Taken vs Lines Cleared")
...
def plot2():
    ...
    ax3.plot(mcts_rows[0], mcts_rows[1], color="blue", label="MCTS First Search")
    ...
    ax3.set_title("MCTS: Time Taken vs Score")
    ax3.legend()


    ax4.plot(mcts_rows[0], mcts_rows[2], color="blue", label="Deep First Search")
    ...
    ax4.set_title("MCTS: Time Taken vs Score")
    ax4.legend()
    ...
    ax5.set_title("Genetic: Time Taken vs Score")
    ax5.legend()
    ...
    ax6.set_title("Genetic: Time Taken vs Score")
    ax6.legend()
